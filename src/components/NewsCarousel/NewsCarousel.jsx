...
function NewsCarousel() {
  return (
    <section className="bg-slate-50 py-10 lg:py-20 -mx-3 md:-mx-4 lg:-mx-5 xl:-mx-25 px-3 md:px-4 lg:px-5 xl:px-25">
      <p className="text-sm uppercase font-semibold">Insights</p>
        ...
        <div className="flex gap-5">
          <div className="flex items-center text-md font-medium gap-4">
            ...
            <div className="flex items-center gap-2">
              <button className="active:bg-green-900 border px-3 py-2 leading-none rounded-full active:text-white text-black font-bold">
                Blogs
              </button>
              <button className="active:bg-green-900 border px-3 py-2 leading-none rounded-full active:text-white text-black font-bold">
                News
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-3 px-20 items-center justify-evenly mt-8">
          {/* LEFT: View All */}
          <button className="text-md font-semibold rounded-full border p-3 cursor-pointer hover:bg-emerald-900 hover:text-white transition-all ease-in duration-150">
            View All Blogs
          </button>
